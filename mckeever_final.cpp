...
void InitGraphicsCustom( ) {
    ...
    // glTexImage2D( GL_TEXTURE_2D, 0, 3, plane_width, plane_width, 0, GL_RGB, GL_UNSIGNED_BYTE, Texture );
    
    glGenTextures( 1, &Tex2 );
    Texture2 = BmpToTexture( (char*)"worldtex.bmp", &width, &height );
...
int RedrawGrid() {
    ...
    return diamond_square(&grid, N, corners, 0.5f, &MaxVal);
}
